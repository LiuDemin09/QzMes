            ...
            $('#grid').datagrid({   //定位到Table标签，Table标签的ID是grid
                ...
                toolbar: [{
                    ...
                    text: '状态 <select tabindex="-1" name="selStatus" id="selStatus"><option value="">请选择</option><option value="0">新建任务</option> <option value="1">分派工艺</option><option value="2">提交工艺</option><option value="3">审核工艺</option>'
                        + '<option value="4">分派编程</option><option value="5">提交编程</option><option value="6">审核编程</option> <option value="9">工艺驳回</option><option value="10">编程驳回</option></select>'
                },  '-', {
                ...
                //    iconCls: 'icon-back',
                //    handler: function () {
                //        window.location.href = "../../Pages/WorkOrderManage/CreateWorkOrder.aspx";
                //    }
                //}
                ],
