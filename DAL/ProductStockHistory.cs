...
{
    [Serializable()]
    [OrmClassAttribute(TableName = "MES_MASTER.PRODUCT_STOCK_HISTORY", IsView = false, PrimaryKeys = "ID",
    PrimaryProperties = "ID")]
    public class ProductStockHistory : ICloneable
    {
        #region Member Variables		
        public static ProductStockHistoryMeta Meta = new ProductStockHistoryMeta();
        #endregion
       ...
       AllowNull = true, ColumnName = "PARTSDRAWING_CODE", SqlType = "VARCHAR2", Length = 40)]
        ...
        public Object Clone()
        {
            ProductStockHistory obj = new ProductStockHistory();
        ...
        public void CopyTo(ProductStockHistory obj)
        {
            obj.ID = this.ID;
            obj.PSN = this.PSN;
            obj.WorkOrder = this.WorkOrder;
    ...
    public sealed class ProductStockHistoryMeta
    {
