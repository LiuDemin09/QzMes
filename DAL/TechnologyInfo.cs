...
{
    [Serializable()]
    [OrmClassAttribute(TableName = "MES_MASTER.TECHNOLOGY_INFO", IsView = false, PrimaryKeys = "ID",
    PrimaryProperties = "ID")]
    public class TechnologyInfo : ICloneable
    {
        #region Member Variables		
        public static TechnologyInfoMeta Meta = new TechnologyInfoMeta();
        #endregion
       ...
       AllowNull = true, ColumnName = "DEVPLAN_DATE", SqlType = "DATE", Length = 0)]
        ...
        public Object Clone()
        {
            TechnologyInfo obj = new TechnologyInfo();
        ...
        public void CopyTo(TechnologyInfo obj)
        {
            obj.ID = this.ID;
            obj.PARTSDRAWINGNO = this.PARTSDRAWINGNO;
            obj.CustName = this.CustName;
    ...
    public sealed class TechnologyInfoMeta
    {
