...
{
    [Serializable()]
    [OrmClassAttribute(TableName = "MES_MASTER.REPRINT_LOG", IsView = false, PrimaryKeys = "ID",
    PrimaryProperties = "ID")]
    public class ReprintLog : ICloneable
    {
        #region Member Variables		
        public static ReprintLogMeta Meta = new ReprintLogMeta();
        #endregion
        ...
        AllowNull = true, ColumnName = "SN", SqlType = "VARCHAR2", Length = 40)]
        public string SN { set; get; }

        [OrmPropertyAttribute(IsChild = false, IsPK = false, IsFK = false, IsIdentity = false, IsUnique = false,
        AllowNull = true, ColumnName = "LABEL_TYPE", SqlType = "VARCHAR2", Length = 40)]
        public string LabelType { set; get; }

        [OrmPropertyAttribute(IsChild = false, IsPK = false, IsFK = false, IsIdentity = false, IsUnique = false,
        AllowNull = true, ColumnName = "REPRINT_BY", SqlType = "VARCHAR2", Length = 40)]
        public string ReprintBy { set; get; }
    ...
    public sealed class ReprintLogMeta
    {
        public StringPropertyMeta ID = new StringPropertyMeta("\"ID\"");
        public StringPropertyMeta SN = new StringPropertyMeta("\"SN\"");
        public StringPropertyMeta LabelType = new StringPropertyMeta("\"LABEL_TYPE\"");
        public StringPropertyMeta ReprintBy = new StringPropertyMeta("\"REPRINT_BY\"");
