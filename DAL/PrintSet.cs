...
{
    [Serializable()]
    [OrmClassAttribute(TableName = "MES_MASTER.PRINT_SET", IsView = false, PrimaryKeys = "ID",
    PrimaryProperties = "ID")]
    public class PrintSet : ICloneable
    {
        #region Member Variables		
        public static PrintSetMeta Meta = new PrintSetMeta();
        #endregion
        ...
        AllowNull = true, ColumnName = "TEMPLATE_TYPE", SqlType = "VARCHAR2", Length = 40)]
        public string TemplateType { set; get; }

        [OrmPropertyAttribute(IsChild = false, IsPK = false, IsFK = false, IsIdentity = false, IsUnique = false,
        AllowNull = true, ColumnName = "TEMPLATE_PATH", SqlType = "VARCHAR2", Length = 400)]
        ...
        public Object Clone()
        {
            PrintSet obj = new PrintSet();

            obj.ID = this.ID;

            obj.TemplateType = this.TemplateType;
            obj.TemplatePath = this.TemplatePath;
        ...
        public void CopyTo(PrintSet obj)
        {
            obj.ID = this.ID;
            obj.TemplateType = this.TemplateType;
            obj.TemplatePath = this.TemplatePath;
    ...
    public sealed class PrintSetMeta
    {
        public StringPropertyMeta ID = new StringPropertyMeta("\"ID\"");
        public StringPropertyMeta TemplateType = new StringPropertyMeta("\"TEMPLATE_TYPE\"");
        public StringPropertyMeta TemplatePath = new StringPropertyMeta("\"TEMPLATE_PATH\"");
