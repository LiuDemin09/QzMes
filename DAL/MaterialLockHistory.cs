...
{
    [Serializable()]
    [OrmClassAttribute(TableName = "MES_MASTER.MATERIAL_LOCK_HISTORY", IsView = false, PrimaryKeys = "ID",
    PrimaryProperties = "ID")]
    public class MaterialLockHistory : ICloneable
    {
        #region Member Variables		
        public static MaterialLockHistoryMeta Meta = new MaterialLockHistoryMeta();
        #endregion

        #region constructor
        public MaterialLockHistory()
        {
        ...
        public Object Clone()
        {
            MaterialLockHistory obj = new MaterialLockHistory();
        ...
        public void CopyTo(MaterialLockHistory obj)
        {
            obj.ID = this.ID;
            obj.MSN = this.MSN;
            obj.MaterialName = this.MaterialName;
    ...
    public sealed class MaterialLockHistoryMeta
    {
