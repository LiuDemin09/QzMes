...
using DAL;
using BLL;
public partial class Pages_OrderManage_OrderNoExport : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //填充头
        string objs = "订单单号,客户名称,合同号,产品名称,零件图号,订单数量,批号,交付时间,创建人,时间";
        ...
        for (int i = 2; i <= objods.Count + 1; i++)
        {
            ...
            cell.SetCellValue(objods[i - 2].CONTRACT);
