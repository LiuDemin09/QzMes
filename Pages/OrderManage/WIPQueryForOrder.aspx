<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WIPQueryForOrder.aspx.cs" Inherits="Pages_OrderManage_WIPQueryForOrder" %>

<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>WIPForOrder</title>
...
<body>
    ...
    <script src="../../Scripts/OrderManage/WIPQueryForOrder.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () { 
            WIPQueryForOrder.init();
            WIPQueryForOrder.initGrid();
        });
