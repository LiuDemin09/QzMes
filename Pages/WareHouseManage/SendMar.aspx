<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendMar.aspx.cs" Inherits="Pages_OrderManage_SendMar" %>
...
<%--            <table id="grid">
    ...
    <script src="../../Scripts/WareHouseManage/SendMar.js" type="text/javascript"></script>
