<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WHTable.aspx.cs" Inherits="Pages_OrderManage_WHTable" %>
...
<%--            <table id="grid">
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr>
                    ...
                    <td  style="height:40px">
                        <a  href="ReceiveMar.aspx" id="btnReceiveMar"class="easyui-linkbutton" data-options="iconCls:'icon-save'"  style="width:90px">收&nbsp;&nbsp;料</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="SendMar.aspx" id="btnSendMar"class="easyui-linkbutton" data-options="iconCls:'icon-undo'"  style="width:90px">发&nbsp;&nbsp;料</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="InWH.aspx" id="btnInWH"class="easyui-linkbutton" data-options="iconCls:'icon-add'"  style="width:90px">入&nbsp;&nbsp;库</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px"> 
                        <a  href="OutWH.aspx" id="btnOutWH"class="easyui-linkbutton" data-options="iconCls:'icon-remove'"  style="width:90px">出&nbsp;&nbsp;库</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="ReturnMar.aspx" id="btnReturnMar"class="easyui-linkbutton" data-options="iconCls:'icon-redo'"  style="width:90px">退&nbsp;&nbsp;料</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="ReturnMar.aspx" id="btnSupportMar"class="easyui-linkbutton" data-options="iconCls:'icon-undo'"  style="width:90px">补&nbsp;&nbsp;料</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="MarStock.aspx" id="btnMarStock"class="easyui-linkbutton" data-options="iconCls:'icon-edit'"  style="width:90px">物料库存</a>
                   
                </tr>
                <tr>
                  
                    <td  style="height:40px">
                        <a  href="ProductStock.aspx" id="btnProductStock"class="easyui-linkbutton" data-options="iconCls:'icon-edit'"  style="width:90px">成品库存</a>
    ...
    <script src="../../Scripts/WareHouseManage/WHTable.js" type="text/javascript"></script>
