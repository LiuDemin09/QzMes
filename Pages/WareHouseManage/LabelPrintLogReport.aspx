<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LabelPrintLogReport.aspx.cs" Inherits="Pages_WareHouseManage_LabelPrintLogReport" %>

<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>条码打印记录报表</title>
...
<body class="easyui-layout">
    ...
    <script src="../../Scripts/WareHouseManage/LabelPrintLogReport.js" type="text/javascript"></script>

    <script>
        jQuery(document).ready(function () {


            LabelPrintLogReport.init();
            LabelPrintLogReport.initGrid();
        });
