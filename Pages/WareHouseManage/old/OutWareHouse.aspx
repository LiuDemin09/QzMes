<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutWareHouse.aspx.cs" Inherits="Pages_WareHouseManage_OutWareHouse" %>
...
<body>
        ...
        <div class="row-fluid"  style="padding:0px;">
					<div class="col-md-9">                                               
                        <div class="portlet box"> 
                            ...
                            <div class="searchbody" style=" padding-top:0;margin:0 auto;"> 
                                 <div id="recinfobackupArea"></div>
                                 <div id="gdbackupList" style="width:100%; height:180px;overflow:auto;border:1px solid #808080;"></div>
					...
					<div class="col-md-3" style="border:1px solid #808080;padding:0px;">                        
                            <div class="portlet box bg-info">
							    <div class="portlet-title">
								    <div class="caption"><span class="text-info">发料</span></div>								    
							    </div>
                            <div class="portlet-body fuelux" style="padding-left:0px">
                                <form action="#" class="form-horizontal ">
                                    ...
                                    <div class="form-group">
                                                   <%-- <label class="col-xs-4 text-right"  for="txtMSN">条码：</label>
                                                 <div class="col-xs-8">
                                                     <div class="controls">
                                                        <input class="form-group" name="txtMSN" id="txtMSN" type="text" placeholder="来料条码">
                                                    </div>
                                                     </div>--%>
                                            <div class="input-group">
                                                <div class="input-group-addon">条&nbsp;码:</div>
                                                <input class="form-control" type="text" name="txtMSN" id="txtMSN" />
                                            </div>
                                      </div>
                                  </div>                                                                                                            
                                </form>
        ...
        <div class="row-fluid"  style="padding:0px;">
                <div class="col-md-12">                                            
                        <div class="portlet box"> 
                            <div class="portlet box bg-info">
                                <div class="portlet-title">
								    <div class="caption"><span class="text-info">发料记录</span></div>								 
							    </div>
                                <div class="portlet-body fuelux" >
                                    <div class="searchbody" style=" padding-top:0;margin:0 auto;border:1px solid #808080;"> 
                                         <div id="recinfoArea"></div>
                                         <div id="gdSendHistoryList" style="width:100%; height:200px;overflow:auto;"></div>
   ...
   <script src="../../ClientMedia/js/app.js" type="text/javascript"></script>    
     <script src="../../Scripts/WareHouseManage/OutWarehouse.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                ...
                OutWarehouse.init();
                OutWarehouse.initGrid();
                OutWarehouse.initGridHistory();
