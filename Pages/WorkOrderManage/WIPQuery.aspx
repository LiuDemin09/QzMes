<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WIPQuery.aspx.cs" Inherits="Pages_WorkOrderManage_WIPQuery" %>
...
<body>
    ...
    <script src="../../Scripts/WorkOrderManage/WIPQuery.js" type="text/javascript"></script>
