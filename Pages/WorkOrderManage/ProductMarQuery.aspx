<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductMarQuery.aspx.cs" Inherits="Pages_WorkOrderManage_ProductMarQuery" %>
...
<body>
    ...
    <script src="../../Scripts/WorkOrderManage/ProductMarQuery.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            ProductMarQuery.init();
            ProductMarQuery.initGrid();
        });
