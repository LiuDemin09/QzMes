<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkOrderQuery3.aspx.cs" Inherits="Pages_WorkOrderManage_WorkOrderQuery3" %>
...
<body>
     ...
     <script src="../../Scripts/WorkOrderManage/WorkOrderQuery3.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () { 
                WorkOrderQuery.init();
                WorkOrderQuery.initGrid(); 
            });
	</script>
