<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartsDrawingQuery1.aspx.cs" Inherits="Pages_WorkOrderManage_PartsDrawingQuery1" %>
...
<body>
    ...
    <script src="../../Scripts/WorkOrderManage/DrawingQuery1.js" type="text/javascript"></script>

    <script>
        jQuery(document).ready(function () {
            DrawingQuery.init();
            DrawingQuery.initGrid();
        });
