<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrackingWipQuery.aspx.cs" Inherits="Pages_WorkOrderManage_TrackingWipQuery" %>
...
<body>
     ...
     <script src="../../Scripts/WorkOrderManage/TrackingWipQuery.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () { 
                TrackingWipQuery.init();
                TrackingWipQuery.initGrid();
            });
	</script>
