<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BossQuery.aspx.cs" Inherits="Pages_WorkOrderManage_BossQuery" %>
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr >                  
                    <td  style="height:40px">
                         <a href="WorkOrderQuery2.aspx" id="btnNew" data-options="iconCls:'icon-search'" class="easyui-linkbutton">&nbsp;工单查询&nbsp;</a>
                   </td>         
              </tr> 
                <tr >                  
                    <td  style="height:40px">
                        <a href="../OrderManage/OrderQuery.aspx" id="btnQuery"  data-options="iconCls:'icon-search'" class="easyui-linkbutton">&nbsp;订单查询&nbsp;</a>
                   </td>         
              </tr> 
                <tr >                  
                    <td  style="height:40px">
                        <a href="../QualityManage/YieldQuery2.aspx" id="btnPartsDrawing" data-options="iconCls:'icon-search'" class="easyui-linkbutton">&nbsp;良率查询&nbsp;</a> 
                   </td>         
              </tr> 
                <tr >                  
                    <td  style="height:40px">
                       <a href="CapacityStatistics2.aspx" id="btnTotal" data-options="iconCls:'icon-search'" class="easyui-linkbutton">&nbsp;产能查询&nbsp;</a>
                   </td>         
              </tr> 
                 <tr >                  
                    <td  style="height:40px">
                       <a href="PartsDrawingQuery1.aspx" id="btnWIP" data-options="iconCls:'icon-search'" class="easyui-linkbutton"> &nbsp;图号查询&nbsp;</a>
                   </td>         
              </tr>             
           </table>
        </div>
    </div>
    <script src="../../Scripts/WorkOrderManage/BossQuery.js" type="text/javascript"></script>
