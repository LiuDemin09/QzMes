<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CapacityStatistics2.aspx.cs" Inherits="Pages_WorkOrderManage_CapacityStatistics2" %>
...
<body>
     ...
     <script src="../../Scripts/WorkOrderManage/CapacityStatistics2.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () { 
                CapacityStatistics.init();
                CapacityStatistics.initGrid();
