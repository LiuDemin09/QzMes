<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysUserPub.aspx.cs" Inherits="Pages_SysManage_SysUserPub" %>
...
<body> 
   <div id="restartDialog" class="easyui-dialog" title="新增员工" style="width: 55%; height: 45%"
    ...
    <script src="../../Scripts/SysManage/SysUserPub.js" type="text/javascript"></script>   
	<script>
