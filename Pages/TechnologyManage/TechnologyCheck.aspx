<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechnologyCheck.aspx.cs" Inherits="Pages_TechnologyManage_TechnologyCheck" %>
...
<body> 
    ...
    <script src="../../Scripts/TechnologyManage/TechnologyCheck.js" type="text/javascript"></script>

    <script>
        jQuery(document).ready(function () { 
            TechnologyCheck.init();
            TechnologyCheck.initGrid(); 
            TechnologyCheck.initGridDetail();
        });
