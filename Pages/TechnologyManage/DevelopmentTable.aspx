<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevelopmentTable.aspx.cs" Inherits="Pages_TechnologyManage_DevelopmentTable" %>
...
<body>
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
        <div id="centerPanel" data-options="region:'center',split:true" style="height: 100%; width: 85%">
             <div id="northPanel" data-options="region:'north',split:true" style="height: 100%">
            <table id="grid">
            </table>
        </div>      
        </div>     
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr>                  
                    <td  style="height:40px">
                        <a  href="DevlopTaskSubmit.aspx" id="btnAllocateTask"class="easyui-linkbutton" data-options="iconCls:'icon-edit'"  style="width:90px">提交任务</a>
                   
                </tr>                
                <tr>
                    <td  style="height:40px"> 
                        <a  href="TechnologyQuery2.aspx" id="btnTechnologyQuery"class="easyui-linkbutton" data-options="iconCls:'icon-search'"  style="width:90px">编程查询</a>
                </tr>
            </table>
        </div>
    </div>
    <script src="../../Scripts/TechnologyManage/DevelopmentTable.js" type="text/javascript"></script>
    <script>
        jQuery(document).ready(function () {
            DevelopmentTable.init();
            DevelopmentTable.initGrid();
        });
