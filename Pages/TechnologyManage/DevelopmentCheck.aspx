<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevelopmentCheck.aspx.cs" Inherits="Pages_TechnologyManage_DevelopmentCheck" %>
...
<body> 
    ...
    <script src="../../Scripts/TechnologyManage/DevelopmentCheck.js" type="text/javascript"></script>

    <script>
        jQuery(document).ready(function () { 
            DevelopmentCheck.init();
            DevelopmentCheck.initGrid();
           // DevelopmentCheck.bindGrid();
            DevelopmentCheck.initGridDetail();
        });
