<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechnologyTable.aspx.cs" Inherits="Pages_TechnologyManage_TechnologyTable" %>
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr>
                    ...
                    <td  style="height:40px">
                        <a  href="TechTaskSubmit.aspx" id="btnAllocateTask"class="easyui-linkbutton" data-options="iconCls:'icon-edit'"  style="width:90px">提交任务</a>
                   
                </tr>
                
                <tr>
                    <td  style="height:40px"> 
                        <a  href="TechnologyQuery1.aspx" id="btnTechnologyQuery"class="easyui-linkbutton" data-options="iconCls:'icon-search'"  style="width:90px">工艺查询</a>
                </tr>
            </table>
        </div>
    </div>
    <script src="../../Scripts/TechnologyManage/TechnologyTable.js" type="text/javascript"></script>
    <script>
        jQuery(document).ready(function () {
            TechnologyTable.init();
            TechnologyTable.initGrid();
        });
