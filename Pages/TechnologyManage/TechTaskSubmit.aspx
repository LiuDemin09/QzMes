<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechTaskSubmit.aspx.cs" Inherits="Pages_TechnologyManage_TechTaskSubmit" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="任务提交" style="width: 60%; height: 90%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                     <th class="panel-header">计划时间</th>
                    <td> 
                         <input type="text" data-options="required:true" name="txtPlanTime" id="txtPlanTime" style="height: 27px; width: 95%" />
                    </td> 
                    <th class="panel-header">工艺文件上传</th>
                    <td>
                          <input type="file" name="uploadify" id="uploadify" />
                    </td> 
                     <th class="panel-header">工艺文件路径</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtuploadpath" id="txtuploadpath" style="height: 27px; width: 95%" />
                    </td>
                   
                </tr>
                <tr><th class="panel-header">路由维护</th></tr>
               <%-- <tr>
            ...
            <div style="background: #fafafa; padding: 5px; width: 98%; border: 1px solid #ccc;text-align:center" >
                <a  id="btnSave" class="easyui-linkbutton" data-options="iconCls:'icon-save'" >提交工艺</a>
     ...
     <script src="../../Scripts/TechnologyManage/TechTaskSubmit.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                TechTaskSubmit.init();
                TechTaskSubmit.initGrid();
            });
	</script>
