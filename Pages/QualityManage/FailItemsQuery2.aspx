<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailItemsQuery2.aspx.cs" Inherits="Pages_QualityManage_FailItemsQuery2" %>
...
<body>
    <div id="allPanel" class="easyui-layout" style="width: 600px; height:500px;"fit="true">
     ...
     <script src="../../Scripts/QualityManage/FailItemsQuery2.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                FailItemsQuery.init();
                FailItemsQuery.initGrid();
