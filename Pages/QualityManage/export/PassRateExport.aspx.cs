...
using DAL;
using BLL;
public partial class Pages_QualityManage_PassRateExport : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (allRate == null || allRate.Length == 0)
        {
        ...
        Row row = null;
        Cell cell = null;
        Sheet hssfSheet = hssfWorkbook.CreateSheet("PassRate");
        row = hssfSheet.CreateRow(0);
        //填充头
        string objhead = "产品数量,一类品数量,二类品数量,返工数量,让步数量,废品数量,一类品率,二类品率,返工率,让步率,废品率";
        ...
        String fileName = "PassRate" + DateTime.Now.ToString("yyyyMMddHHmmss");
        Response.Clear();
