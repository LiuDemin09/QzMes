<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckUnsureness.aspx.cs" Inherits="Pages_QualityManage_CheckUnsureness" %>
...
<body>
     ...
     <script src="../../Scripts/QualityManage/CheckUnsureness.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                CheckUnsureness.init();
                CheckUnsureness.initGrid();
