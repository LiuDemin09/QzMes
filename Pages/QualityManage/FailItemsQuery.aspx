<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailItemsQuery.aspx.cs" Inherits="Pages_QualityManage_FailItemsQuery" %>
...
<body>
    <div id="allPanel" class="easyui-layout" style="width: 600px; height:500px;"fit="true">
     ...
     <script src="../../Scripts/QualityManage/FailItemsQuery.js" type="text/javascript"></script> 
