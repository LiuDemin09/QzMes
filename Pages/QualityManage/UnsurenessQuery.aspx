<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnsurenessQuery.aspx.cs" Inherits="Pages_QualityManage_UnsurenessQuery" %>
...
<body>
    ...
    <script src="../../Scripts/QualityManage/UnsurenessQuery.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            UnsurenessQuery.init();
            UnsurenessQuery.initGrid();
        });
