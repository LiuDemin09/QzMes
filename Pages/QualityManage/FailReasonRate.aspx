<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailReasonRate.aspx.cs" Inherits="Pages_QualityManage_FailReasonRate" %>
...
<head>
    ...
    <%--<script type="text/javascript" src="../../Scripts/Highcharts-5.0.12/code/highcharts.js"></script>
    <script type="text/javascript" src="../../Scripts/Highcharts-5.0.12/code/modules/drilldown.js"></script>
    <script type="text/javascript" src="../../Scripts/Highcharts-5.0.12/code/modules/exporting.js"></script>--%>
     <script type="text/javascript" src="../../Scripts/eKanBan/highcharts-zh_CN.js"></script>
...
<body>
    <div id="container" style="width: 70%; height: 500px; margin: 0 auto"></div>
    ...
    <script src="../../Scripts/QualityManage/FailReasonRate.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            FailReasonRate.init();
           // FailReasonRate.initGrid();
        });
