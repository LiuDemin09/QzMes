<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PassRateQuery.aspx.cs" Inherits="Pages_QualityManage_PassRateQuery" %>
...
<body>
    <div id="container" style="width: 30%; height: 400px; float: left; margin: 0 auto"></div>
    <div id="container1" style="width: 30%; height: 400px; margin: 0 auto"></div>
   <%-- <div id="allPanel" style="width: 100%;" fit="true">
    ...
    <script src="../../Scripts/QualityManage/PassRateQuery.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            PassRateQuery.init();
            PassRateQuery.initGrid();
        });
