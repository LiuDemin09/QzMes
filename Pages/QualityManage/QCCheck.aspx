<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QCCheck.aspx.cs" Inherits="Pages_QualityManage_QCCheck" %>
...
<body>
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
            ...
            <form action="#" class="form-horizontal " style="padding-top:10px;">                    
                <div class="form-group">                           
                    ...
                    <div class="btn-group" role="group" aria-label="...">
                       ...
                       <%-- <label for="txtInputData1"  class="col-md-2 text-right">终检作业:</label>
                    <div class="col-md-3">                                
                        <input type="text" class="form-control"  name="txtInputData1" id="txtInputData" />
                    </div>--%>
                </div>
     ...
     <script src="../../Scripts/QualityManage/QCCheck.js" type="text/javascript"></script> 
