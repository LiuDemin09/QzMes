<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnsurenessIn.aspx.cs" Inherits="Pages_QualityManage_UnsurenessIn" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="新录待处理品" style="width: 40%; height: 50%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    <th class="panel-header">产品条码</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtPSN" id="txtPSN" style="height: 27px; width: 95%" />
                    </td>
                     
                </tr>
                <tr>
                    <th class="panel-header">不良项</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtFailCode" id="txtFailCode" style="height: 27px; width: 95%" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%--<select tabindex="-1" data-options="required:true" name="txtFailMemo" id="txtFailMemo"  style="height: 27px; width: 95%">
                        </select>--%>
                    </td>
    ...
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/QualityManage/UnsurenessIn.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () { 
                UnsurenessIn.init();
                UnsurenessIn.initGrid(); 
            });
	</script>
