<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustPassRate.aspx.cs" Inherits="Pages_QualityManage_CustPassRate" %>
...
<body>
    <div id="container" style="width: 30%; height: 400px; margin: 0 auto"></div>
    ...
    <script src="../../Scripts/QualityManage/CustPassRate.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            CustPassRate.init();
            CustPassRate.initGrid();
        });
