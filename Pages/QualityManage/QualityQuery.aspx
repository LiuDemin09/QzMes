<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QualityQuery.aspx.cs" Inherits="Pages_QualityManage_QualityQuery" %>
...
<body>
    ...
    <script src="../../Scripts/QualityManage/QualityQuery.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
        jQuery(document).ready(function () {
            QualityQuery.init();
            QualityQuery.initGrid();
        });
