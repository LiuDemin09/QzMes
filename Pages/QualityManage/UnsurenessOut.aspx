<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnsurenessOut.aspx.cs" Inherits="Pages_QualityManage_UnsurenessOut" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="新录待处理品" style="width: 40%; height: 50%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    <th class="panel-header">处理方案</th>
                    <td>                        
                        <select tabindex="-1" data-options="required:true" name="selresult" id="selresult"  style="height: 27px; width: 95%">
    ...
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/QualityManage/UnsurenessOut.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                UnsurenessOut.init();
                UnsurenessOut.initGrid();
            });
	</script>
