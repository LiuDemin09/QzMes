<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LatheTask.aspx.cs" Inherits="Pages_ProductionManage_LatheTask" %>
...
<body> 
   <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
            ...
            <form class="form-horizontal " style="padding-top:10px;">                    
                <div class="form-group">                           
                    ...
                    <div class="btn-group" role="group" aria-label="...">
                        <%--<button type="button" id="btnmsn" class="btn btn-default">扫来料条码--></button>
                        <button type="button" id="btnstart" class="btn btn-default">扫开工--></button>--%>
                        ...
                        <%--<button type="button" id="btnfinish" class="btn btn-default">扫收工</button>--%>                                 
                    </div>
                       <%-- <label for="txtInputData" class="col-md-2 text-right">生产报工:</label>--%>
                    <div class="col-md-3">   
                         <%--<input type="text" data-options="required:true"  id="txtInputData2" />                            
                        <input type="text"  id="txtInputData1" /> 
                        <input type="text" class="form-control" name="txtInputData" id="txtInputData" />--%>
                    </div>
                </div>
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr >                  
                 ...
                 <%-- <td  style="height:40px">
                        <img src="../../images/product/start.png" class="img-responsive" alt="开工" />
                   </td>--%>
                   <td  style="height:40px">
                ...
                <tr >                  
                    ...
                    <%-- <td  style="height:40px">
                         <img src="../../images/product/finish.png" class="img-responsive" alt="收工" />
                   </td>  --%>     
              </tr> 
                <tr >   
                    <td  style="height:40px">
     ...
     <script src="../../Scripts/ProductionManage/LatheTask.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () { 
                LatheTask.init();
                LatheTask.initGrid();
                LatheTask.initGridHistory(); 
            });
	</script>
