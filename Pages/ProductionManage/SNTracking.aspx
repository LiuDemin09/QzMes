<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SNTracking.aspx.cs" Inherits="Pages_ProductionManage_SNTracking" %>
...
<body>
   <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
        <div id="centerPanel" data-options="region:'center',split:true" style="height: 100%;width: 98%; ">
            <table id="grid">
            </table>
        </div>
    </div>
     <script src="../../Scripts/ProductionManage/SNTracking.js" type="text/javascript"></script> 
