<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartsDrawingNo.aspx.cs" Inherits="Pages_BaseInfo_PartsDrawingNo" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="新建图号" style="width: 60%; height: 60%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" data-options="required:true" name="txtPartCode" id="txtPartCode" style="height: 27px; width: 95%" /></td>
    ...
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/BaseInfo/PartsDrawingNo.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                PartsDrawingNo.init();
                PartsDrawingNo.initGrid();
            });
