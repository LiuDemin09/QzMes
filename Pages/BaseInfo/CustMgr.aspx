<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustMgr.aspx.cs" Inherits="Pages_BaseInfo_CustMgr" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="新建客户" style="width: 60%; height: 60%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    <th class="panel-header">客户代码</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtCustCode" id="txtCustCode" style="height: 27px; width: 95%" />
                    </td>
                ...
                <tr>
                    <th class="panel-header">地址</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtAddress" id="txtAddress" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">运输方式</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtTransType" id="txtTransType" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">收货地点</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtReceiveArea" id="txtReceiveArea" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">联系人</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtContact" id="txtContact" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">电话</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtMobile" id="txtMobile" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">传真</th>
                    <td>
                      <input type="text" data-options="required:true" name="txtFax" id="txtFax" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">开票名称</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtInvoiceName" id="txtInvoiceName" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">开票税号</th>
                    <td>
                       <input type="text" data-options="required:true" name="txtInvoiceNumber" id="txtInvoiceNumber" style="height: 27px; width: 95%" />
                    </td>
                </tr>
            </table>
            ...
            <table style=" text-align: center; vertical-align: middle;width:100%">
              <tr >                  
                    <td  style="height:40px">
                       <a id="btnAddCust" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新建客户</a> 
                   </td>         
              </tr>              
           </table>
        </div>
    </div>
    <script src="../../Scripts/BaseInfo/CustMgr.js" type="text/javascript"></script>
    <script>
