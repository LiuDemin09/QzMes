<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterielMgr.aspx.cs" Inherits="Pages_BaseInfo_MaterielMgr" %>
...
<body>
    <div id="restartDialog" class="easyui-dialog" title="新建料号" style="width: 60%; height: 60%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    <th class="panel-header">钦纵料号</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtQZMaterielNo" id="txtQZMaterielNo" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">客户料号</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtCustMaterielNo" id="txtCustMaterielNo" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">料号名称</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtMaterielName" id="txtMaterielName" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">基板数</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtBasQty" id="txtBasQty" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">客户名称</th>
                    <td>
                        <select tabindex="-1" data-options="required:true" name="selCustName" id="selCustName"  style="height: 27px; width: 95%">
                        </select>
                    </td>
                    <th class="panel-header">备&nbsp;&nbsp;注</th>
                    <td>
    ...
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/BaseInfo/MaterielMgr.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                MaterielMgr.init();
                MaterielMgr.initGrid();
            });
