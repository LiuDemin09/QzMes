<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SequenceNo.aspx.cs" Inherits="Pages_BaseInfo_SequenceNo" %>
...
<body>
     <div id="restartDialog" class="easyui-dialog" title="新建序列号" style="width: 60%; height: 60%"
        ...
        <form id="resumeForm">
            ...
            <table id="myResume" bordercolordark="#FFFFFF" bordercolorlight="#45b97c" border="1px" cellpadding="0" cellspacing="0" style="width: 98%; height: 100%">
                ...
                <tr>
                    <th class="panel-header">序列号名</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtSequenceNoName" id="txtSequenceNoName" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">产品系列</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtProductSequence" id="txtProductSequence" style="height: 27px; width: 95%" />
                    </td>
                </tr>
                <tr>
                    <th class="panel-header">数字长度</th>
                    <td>
                        <input type="text" data-options="required:true" name="txtSequenceLen" id="txtSequenceLen" style="height: 27px; width: 95%" />
                    </td>
                    <th class="panel-header">数字类型</th>
                    <td>
                        <select tabindex="-1" data-options="required:true" name="selDigitalType" id="selDigitalType"  style="height: 27px; width: 95%">
                ...
                <tr>
                    <th class="panel-header">增加模式</th>
                    <td>
                        <select tabindex="-1" data-options="required:true" name="selIncreaseMode" id="selIncreaseMode"  style="height: 27px; width: 95%">
                            <option value="1">自然增长</option>
                            <option value="2">按天增长</option>
                            <option value="3">按月增长</option>
                            <option value="4">按年增长</option>                            
                        </select>
                    </td>                    
                </tr>                 
            </table>
    ...
    <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/BaseInfo/SequenceNo.js" type="text/javascript"></script> 
