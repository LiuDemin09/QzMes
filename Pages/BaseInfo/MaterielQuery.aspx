<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterielQuery.aspx.cs" Inherits="Pages_BaseInfo_MaterielQuery" %>
...
<body>
     ...
     <script src="../../Scripts/BaseInfo/MaterielQuery.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                MaterielQuery.init();
                MaterielQuery.initGrid();
            });
