<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipmentQuery.aspx.cs" Inherits="Pages_BaseInfo_EquipmentQuery" %>
...
<body>
   <div id="allPanel" class="easyui-layout" style="width: 600px; height: 400px;" fit="true">
     ...
     <script src="../../Scripts/BaseInfo/EquipmentQuery.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS -->  
        <script>
            jQuery(document).ready(function () {
                EquipmentQuery.init();
                EquipmentQuery.initGrid();
            });
